...
class PluginResponseDto {
  ...
  static PluginResponseDto? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'actions'), 'Required key "PluginResponseDto[actions]" is missing from JSON.');
        assert(json[r'actions'] != null, 'Required key "PluginResponseDto[actions]" has a null value in JSON.');
        ...
        assert(json.containsKey(r'filters'), 'Required key "PluginResponseDto[filters]" is missing from JSON.');
        assert(json[r'filters'] != null, 'Required key "PluginResponseDto[filters]" has a null value in JSON.');
